...
In een datagedreven organisatie zijn allerlei rollen benoemd en toegekend aan mensen zodat het gebruik van data ook echt tot waardecreatie kan leiden. De DST heeft een belangrijke rol als verbindende factor tussen de meeste1 van deze rollen.
...
3. Omzetten daadwerkelijke vraag naar functionaliteit en user stories
4. Bepalen technische haalbaarheid
5. Prioriteren o.b.v. haalbaarheid en businesswaarde
	
Vraag centraal stellen

Belangrijkste rollen - de AT heeft in alle stappen van het verkennen en prioriteren een leidende rol

User story opbreken tot het niveau dat je het kan doorgeven aan een ander die er mee verder moet
...
3. Schetsen van  het eindresultaten DG oplossing
4. Opstellen van de benodigde data-infrastructuur
5. Plan van aanpak voor de Proof of Concept 

Resultaat Solution Design

- Schetsen (mock-up) van het eindresultaat (niet functioneel / wel beeld) - Shiny UI builder
- Verkennende data-analyse voor koppeling databronnen - kwaliteit van data en koppelbaarheid (ongelijke sleutels)
- Succesvolle implementatie vraag data-management
...
- Eerste werkende versie van de DG oplossing
- Eerste test of de veronderstelde waarde ook gerealiseerd kan worden.
- Opstellen van een PvA voor de Pilot-fase

1. Creeeren train, test en validatiedatasets
2. Realiseren van de DG oplossing (iteratief)
3. Kwaliteit van de DG oplossing bepalen en aanscherpen (iteratief)
4. Business case opstellen, aanscherpen haalbaarheid en uitbreiden aspecten rondom ethiek en privacy - doel BC is om de toegeovegde waarde aan te tonen.
5. PvA voor vervolgfases ontwikkelen en afstemmen.
