...
![](images/paste-ABACEECC.png){.column-margin group="blok1"}
...
![](images/paste-23E5C850.png){.column-margin group="blok1"}
...
![](images/paste-667C9B2C.png){.margin-column group="blok1" fig-alt="Succesfactoren voor een datagedreven organisatie"}
...
![](images/paste-EA59974D.png){.column-margin group="blok1"}
...
![](images/paste-C3D57386.png){.column-margin group="blok1"}
...
![](foto_competenties_AT.jpg){group="blok1" fig-alt="Competenties voor de Analytics Translator" fig-align="center" width="310"}
...
![](images/paste-56F1EEF7.png){group="blok1"}
