...
-   **R for Data Science (R4DS)** - Hadley Wickham - *2019*
    ...
    -   <https://r4ds.hadley.nz/> (2nd edition)
...
-   The Big Book of R - Oscar Baruffa
    -   <https://www.bigbookofr.com/>
    -   Verzameling van allerlei (online) boeken over R en gerelateerde onderwerpen
-   HTTP testing in R
...
-   **Leading with AI and Analytics** - Eric Anderson, Florian Zettelmeyer - *2023 (Luisterboek)*
    -   Boek voor managers om AI en anlytics te benutten - Build your data science IQ to drive business value.
    -   *In this book, you'll find the essential tools to help you: develop a strong data science intuition quotient, lead and scale AI and analytics throughout your organization, move from "best-guess" decision making to evidence-based decisions, and craft strategies and tactics to create real impact.*
    -   [Audible](https://www.audible.co.uk/pd/Leading-with-AI-and-Analytics-Audiobook/B09R34LTKD)
...
-   **The design of everyday things** - Don Norman - *2017/2024 (Luisterboek)*
    -   Over ontwerpen: hoe maak je iets dat goed functioneert, dat voldoet aan de wensen van de gebruikers.
    -   [Audible](https://www.audible.de/pd/The-Design-of-Everyday-Things-Hoerbuch/B07L5KY2XG)
...
-   **The Creative Habit** - Twyla Tharp - *2021/2024 - (Luisterboek)*
    -   Erg leuk boek, ook al gaat het veel over dans.
    -   [The Creative Habit - Audible](https://www.audible.de/pd/The-Creative-Habit-Hoerbuch/B00BTETLLU)
...
-   **Thinking, Fast and slow - Daniel Kahneman - 2022**
    -   Over hoe je hersenen werken en dat dat niet altijd zo rationeel is als je zou denken.
-   **How we learn - The Surprising Truth About When, Where, and Why It Happens** - Benedict Carey - *2022*
    -   Over op welke manieren we informatie onthouden. Dat is soms anders dan je zou denken.
-   **The programmers brain** - Felienne Hermans - *2021*
    -   Hoe je inzichten over de werking van de hersenen praktisch kunt toepassen bij het (leren van) programmeren.
-   **Mindset** - Carol Dweck - *2023 (Luisterboek)*
    ...
    -   [Audible](https://www.audible.de/pd/Mindset-Updated-Edition-Hoerbuch/140554399X)
-   **Nudge: The Final Edition** - Richard H. Thaler, Cass R. Sunstein - *2024 (Luisterboek)*
    -   Improving Decisions About Money, Health, and the Environment
    -   [Audible](https://www.audible.de/pd/Nudge-The-Final-Edition-Hoerbuch/1663714924)

## Werk en productiviteit

-   **Rework** - Jason Fried, David Heinemeier Hanson - *2021*
    -   Hoe je werk en het functioneren van een bedrijf anders aan kunt pakken. Nadruk op hoe je het simpel en effectief kunt houden.
-   **Deep Work** - Cal Newport - *2023 (Luisterboek)*
    -   Over hoe je zorg dat je geconcentreerd werkt zonder afgeleid te raken.
    -   [Audible](https://www.audible.de/pd/Deep-Work-Hoerbuch/B01CYLJ49U)
-   **The Progress Principle** - Teresa M. Amabile - **2023 (Luisterboek)**
    ...
    -   [Audible](https://www.audible.de/pd/The-Progress-Principle-Hoerbuch/B0BSMW53Q1)
-   *Become an Analytic Translator - Wendy D. Lynch - 2024*
    -   [Amazon](https://www.amazon.com/Become-Analytic-Translator-Business-Analysts/dp/0578316803)
...
-   **Socrates op Sneakers** - Elke Wiss - *2023 (Luisterboek)*
    -   Over diepgaande gesprekken, vragenstellen en doorvragen
    -   [Online Bibliotheek](https://www.onlinebibliotheek.nl/catalogus/433176369/socrates-op-sneakers--)
...
-   **Why We Sleep** - Matthew Walker - *2024*
    -   [Audible](https://www.audible.de/pd/Why-We-Sleep-Hoerbuch/B07613968Q)
...
-   *Rework*
    ...
    -   Interessante podcast over werk, kleine bedrijven en het boek Rework
-   *De Dataloog*
    -   <https://dedataloog.nl/>
    -   De Dataloog is de onafhankelijke Nederlandstalige podcast over data & kunstmatige intelligentie. Hier hoor je alles wat je moet weten over de zin en onzin van data, de nieuwste ontwikkelingen en echte verhalen uit de praktijk.
...
-   *Signal v. Noise* - Jason Fried, David Heinemeier Hanson and others
    -   <https://m.signalvnoise.com/>
    -   Blog over werken, software en meer interessante thema's uit Rework
    -   [Validation is a mirage](https://m.signalvnoise.com/validation-is-a-mirage/)
