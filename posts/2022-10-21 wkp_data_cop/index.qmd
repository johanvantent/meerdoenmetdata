...
# Downloaden van waterschapsgrenzen van PDOK als achtergrond
...
ws_grenzen <- sf::st_read("data/AdministrativeUnits_ETRS89.gml") %>% sf::st_transform(crs = 28992)
...
De library `vroom` is heel geschikt voor deze aanpak. `vroom` kan een groot aantal tekstbestanden indexeren en dit als een lazy[^1] dataframe beschikbaar maken.
